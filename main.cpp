...
int main(int argc, char* argv[]) {
	...
	//now in both multimaps must remain elements like size, extension -> file1, but there is no same file1 in another storage
	...
	//in backup must remain elements like size, extension -> file1,
	...
	//now in both multimaps must be elements like hash1 -> file1, and file with this hash may be in another storage, under different name or relative location
	...
	//now in both multimaps must be elements like hash1 -> file1, but there is no file with the same hash in another storage
